...
\_**Tip**: if you haven't done so already, you can run `websemantics/file-icons-js` so that all your files have icons that display in the file tree, making them easier to distinguish. Atom and VS Code also have extensions that do this e.g. Material Icon Theme.
